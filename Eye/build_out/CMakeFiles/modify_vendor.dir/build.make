...
scripts/install.sh:
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/home/ma-user/work/ypy/Eye/build_out/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating scripts/install.sh, scripts/upgrade.sh"
	mkdir -p /home/ma-user/work/ypy/Eye/build_out/scripts
	cp -r /home/ma-user/work/ypy/Eye/scripts/* /home/ma-user/work/ypy/Eye/build_out/scripts/
	sed -i s/vendor_name=customize/vendor_name=customize/g /home/ma-user/work/ypy/Eye/build_out/scripts/*
